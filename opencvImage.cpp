...
//  namedWindow("Trackbar2",(500,500));
//  createTrackbar("Thres2","Trackbar2",&T2,255);
//  while(1){
threshold(finalGB,finalT,31,255,THRESH_BINARY);
// imshow("thres",finalT);
// char c=waitKey(1);
// if(c==27){
//     break;
